...
public class BuddingRedstoneBlock extends AmethystBlock {
    ...
    public void randomTick(BlockState p_220898_, ServerLevel p_220899_, BlockPos p_220900_, RandomSource p_220901_) {
        if (p_220901_.nextInt(5) == 0) {
            ...
            } else if (blockstate.is(ModBlocks.SMALL_REDSTONE_BUD.get()) && blockstate.getValue(AmethystClusterBlock.FACING) == direction) {
                block = ModBlocks.MEDIUM_REDSTONE_BUD.get();
            } else if (blockstate.is(ModBlocks.MEDIUM_REDSTONE_BUD.get()) && blockstate.getValue(AmethystClusterBlock.FACING) == direction) {
                block = ModBlocks.LARGE_REDSTONE_BUD.get();
            } else if (blockstate.is(ModBlocks.LARGE_REDSTONE_BUD.get()) && blockstate.getValue(AmethystClusterBlock.FACING) == direction) {
